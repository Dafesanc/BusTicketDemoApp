        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusVehicleNo = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    FromLocation = table.Column<int>(type: "integer", nullable: false),
                    ToLocation = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 23, 14, 0, 0, 0, DateTimeKind.Utc), "Express CDMX-GDL", "ADN-001", new DateTime(2025, 6, 23, 8, 0, 0, 0, DateTimeKind.Utc), 1, 450.00m, new DateTime(2025, 6, 23, 0, 0, 0, 0, DateTimeKind.Utc), 2, 42, 1 },
                    { 2, new DateTime(2025, 6, 23, 20, 0, 0, 0, DateTimeKind.Utc), "Ejecutivo CDMX-MTY", "ADN-002", new DateTime(2025, 6, 23, 10, 0, 0, 0, DateTimeKind.Utc), 1, 650.00m, new DateTime(2025, 6, 23, 0, 0, 0, 0, DateTimeKind.Utc), 3, 38, 1 },
                    { 3, new DateTime(2025, 6, 24, 16, 0, 0, 0, DateTimeKind.Utc), "Primera Plus GDL-CUN", "PP-101", new DateTime(2025, 6, 23, 22, 0, 0, 0, DateTimeKind.Utc), 2, 980.00m, new DateTime(2025, 6, 23, 0, 0, 0, 0, DateTimeKind.Utc), 5, 40, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@busticket.com", "Administrador del Sistema", "admin123", "BusTicketDemo", null, null, "Admin", "admin" },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "customer1@email.com", "Juan Pérez", "customer123", "BusTicketDemo", null, null, "Customer", "customer1" },
                    { 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "vendor1@email.com", "María González", "vendor123", "BusTicketDemo", null, null, "Vendor", "vendor1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "info@autobusdelnorte.com", "+52-55-1234-5678", "Autobuses del Norte" },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "contacto@primeraplus.com", "+52-33-9876-5432", "Primera Plus" }
                });
